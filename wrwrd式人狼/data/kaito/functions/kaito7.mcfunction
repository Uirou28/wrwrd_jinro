...
execute as @a[tag=player7,team=jinro] as @a[team=jinro,tag=!player1] run tellraw @a[tag=kaito] [{"selector":"@a[team=jinro,tag=!player1]"},{"text":"が仲間です"}]
...
tag @a[tag=player7,team=yogen] add yogenk
...
tag @a[tag=player7,team=tantei] add tank
