team add jinro
team join jinro @r[limit=3,team=!killer,team=!youko,tag=!kaito]
team modify jinro nametagVisibility hideForOtherTeams
tag @r[limit=7,team=!jinro,team=!killer,team=!youko,tag=!kaito] add mura
team add simin
team join simin @r[tag=mura,limit=5]
