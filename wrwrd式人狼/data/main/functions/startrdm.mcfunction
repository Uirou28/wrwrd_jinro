...
tag @e[type=armor_stand,tag=spawn0,limit=1] add spawn1
tag @e[type=armor_stand,tag=spawn1] remove spawn0
tag @e[type=armor_stand,tag=spawn0,limit=1] add spawn2
tag @e[type=armor_stand,tag=spawn2] remove spawn0
tag @e[type=armor_stand,tag=spawn0,limit=1] add spawn3
tag @e[type=armor_stand,tag=spawn3] remove spawn0
tag @e[type=armor_stand,tag=spawn0,limit=1] add spawn4
tag @e[type=armor_stand,tag=spawn4] remove spawn0
tag @e[type=armor_stand,tag=spawn0,limit=1] add spawn5
tag @e[type=armor_stand,tag=spawn5] remove spawn0
tag @e[type=armor_stand,tag=spawn0,limit=1] add spawn6
tag @e[type=armor_stand,tag=spawn6] remove spawn0
tag @e[type=armor_stand,tag=spawn0,limit=1] add spawn7
tag @e[type=armor_stand,tag=spawn7] remove spawn0
tag @e[type=armor_stand,tag=spawn0,limit=1] add spawn8
tag @e[type=armor_stand,tag=spawn8] remove spawn0
tag @e[type=armor_stand,tag=spawn0,limit=1] add spawn9
...
tp @a[tag=player4] @e[type=armor_stand,limit=1,tag=spawn5]
