...
execute as @e[type=armor_stand,tag=game,tag=!kaitoV] run give @a[team=jinro] written_book{display:{Name:'{"text":"役職本","color":"dark_gray","bold":true}'},HideFlags:39,title:"役職本",author:"GM",pages:['[{"text":"§7あなたは§0人狼§7です\\n","bold":true},{"text":"(クリックで仲間を確認)","clickEvent":{"action":"run_command","value":"/function main:jinro"}}]']} 1
execute as @e[type=armor_stand,tag=game,tag=!kaitoV] run give @a[team=yogen] written_book{display:{Name:'{"text":"役職本","color":"dark_gray","bold":true}'},HideFlags:39,title:"役職本",author:"GM",pages:['[{"text":"あなたは§1予言者§rです 予言先を決めてください\\n","bold":true},{"text":"(クリックで予言開始)","clickEvent":{"action":"run_command","value":"/function yogen:doyogen"}}]']} 1
execute as @e[type=armor_stand,tag=game,tag=!kaitoV] run give @a[team=tantei] written_book{display:{Name:'{"text":"役職本","color":"dark_gray","bold":true}'},HideFlags:39,title:"役職本",author:"GM",pages:['[{"text":"あなたは§6霊媒師§rです 霊媒先を決めてください\\n","bold":true},{"text":"(クリックで霊媒開始)","clickEvent":{"action":"run_command","value":"/function tan:dotantei"}}]']} 1
execute as @e[type=armor_stand,tag=game,tag=kaitoV] run give @a[team=jinro] written_book{display:{Name:'{"text":"役職本","color":"dark_gray","bold":true}'},HideFlags:39,title:"役職本",author:"GM",pages:['[{"text":"§7あなたは§0人狼§7です\\n","bold":true}]']} 1
execute as @e[type=armor_stand,tag=game,tag=kaitoV,scores={player=5..}] run tellraw @a[team=jinro] [{"selector":"@a[team=jinro]"},{"text":"が人狼の仲間です","bold":true}]
...
give @a written_book{display:{Name:'{"text":"緊急スイッチ","color":"dark_gray","bold":true}'},HideFlags:39,title:"緊急スイッチ",author:"GM",pages:['[{"text":"クリックで会議開始","bold":true,"clickEvent":{"action":"run_command","value":"/execute at @e[type=armor_stand,tag=kaigi,scores={kaigitime=0}] run function main:kaigi"}}]']} 1
